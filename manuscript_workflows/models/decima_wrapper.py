#!/usr/bin/env python3
"""
Decima sequence wrapper for Stage-0.
...
DecimaModel = _load_decima_model()
...
class DecimaSequenceWrapper(nn.Module):
    ...
    def __init__(
        ...
        # Instantiate DecimaModel; we only use embedding; head will be frozen/unused.
        self.decima = DecimaModel(n_tasks=n_tasks, init_borzoi=False)
