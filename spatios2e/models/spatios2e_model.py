#!/usr/bin/env python3
"""SpatioS2E residual-decomposition model."""
...
class SpatioS2EModel(GeneConditionedResidualModel):
    """Residual expression model combining morphology, spatial context, and gene priors."""
    ...
    def __init__(
        ...
        if residual_scale_path is None:
            raise ValueError("residual_scale_path is required for SpatioS2EModel")
